...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    const handleIncoming = (data: { from: any; message: string }) => {
      console.log("useeffect runing")
      console.log(data)
      saveMessageToFriend(realm, data.from, data.message, 'them');
    };
    ...
    <View className='h-full w-full'>
      ...
      <View className='h-[10vh] w-full'>
        <View className="flex-row items-center bg-gray-200 rounded-full px-4 py-2 mx-4 my-2">
          <Image source={require("../../../assets/Icons/search-interface-symbol.png")} className="w-5 h-5 mr-2 tint-gray-500" />
          <TextInput
